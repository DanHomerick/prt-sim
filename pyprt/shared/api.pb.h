...
const SimMsgType SimMsgType_MIN = SIM_COMPLETE_VEHICLE_SPEED;
...
class PolyCoeffs : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< float >& coeffs() const
      ;
  inline ::google::protobuf::RepeatedField< float >* mutable_coeffs();
...
class Spline : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::PolyCoeffs >& polys() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::PolyCoeffs >* mutable_polys();
  ...
  inline const ::google::protobuf::RepeatedField< float >& times() const
      ;
  inline ::google::protobuf::RepeatedField< float >* mutable_times();
...
class CtrlCmdPassengersEmbark : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& passengerids() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_passengerids();
...
class SimResponseTotalStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::VehicleStatus >& v_statuses() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::VehicleStatus >* mutable_v_statuses();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::StationStatus >& s_statuses() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::StationStatus >* mutable_s_statuses();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::PassengerStatus >& p_statuses() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::PassengerStatus >* mutable_p_statuses();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::SwitchStatus >& sw_statuses() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::SwitchStatus >* mutable_sw_statuses();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::TrackSegmentStatus >& ts_statuses() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::TrackSegmentStatus >* mutable_ts_statuses();
...
class SimNotifyStationReadyLaunch : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_pid();
  static const int kPIDFieldNumber = 3;
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& pid() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_pid();
...
class SimMsgBodyInvalidId : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_locid() const;
  inline void clear_locid();
  static const int kLocIDFieldNumber = 3;
  inline ::google::protobuf::int32 locid() const;
  inline void set_locid(::google::protobuf::int32 value);
...
class SimMsgBodyInvalidAccel : public ::google::protobuf::Message {
 public:
  SimMsgBodyInvalidAccel();
  virtual ~SimMsgBodyInvalidAccel();
  
  SimMsgBodyInvalidAccel(const SimMsgBodyInvalidAccel& from);
  
  inline SimMsgBodyInvalidAccel& operator=(const SimMsgBodyInvalidAccel& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SimMsgBodyInvalidAccel& default_instance();
  void Swap(SimMsgBodyInvalidAccel* other);
  
  // implements Message ----------------------------------------------
  
  SimMsgBodyInvalidAccel* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SimMsgBodyInvalidAccel& from);
  void MergeFrom(const SimMsgBodyInvalidAccel& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static SimMsgBodyInvalidAccel* default_instance_;
};
// -------------------------------------------------------------------

class SimMsgBodyInvalidJerk : public ::google::protobuf::Message {
 public:
  SimMsgBodyInvalidJerk();
  virtual ~SimMsgBodyInvalidJerk();
  
  SimMsgBodyInvalidJerk(const SimMsgBodyInvalidJerk& from);
  
  inline SimMsgBodyInvalidJerk& operator=(const SimMsgBodyInvalidJerk& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SimMsgBodyInvalidJerk& default_instance();
  void Swap(SimMsgBodyInvalidJerk* other);
  
  // implements Message ----------------------------------------------
  
  SimMsgBodyInvalidJerk* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const SimMsgBodyInvalidJerk& from);
  void MergeFrom(const SimMsgBodyInvalidJerk& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline ::google::protobuf::int32 jerk() const;
  inline void set_jerk(::google::protobuf::int32 value);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static SimMsgBodyInvalidJerk* default_instance_;
};
// -------------------------------------------------------------------
...
class VehicleStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& passengerid() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_passengerid();
...
class StationSummary : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& loaded_ready_launch() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_loaded_ready_launch();
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& unloaded_ready_launch() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_unloaded_ready_launch();
...
class StationStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::PlatformStatus >& platform_status() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::PlatformStatus >* mutable_platform_status();
...
class PlatformStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::BerthStatus >& berths() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::BerthStatus >* mutable_berths();
...
class PassengerStatus : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 travel_time() const;
  inline void set_travel_time(::google::protobuf::int32 value);
  
  // optional bool trip_complete = 10;
  inline bool has_trip_complete() const;
  inline void clear_trip_complete();
  static const int kTripCompleteFieldNumber = 10;
  ...
  static const int kTripSuccessFieldNumber = 11;
...
class SwitchStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::prt::RoutingEntry >& entry() const;
  inline ::google::protobuf::RepeatedPtrField< ::prt::RoutingEntry >* mutable_entry();
...
class TrackSegmentStatus : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& vid() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_vid();
...
inline ::google::protobuf::int32 CtrlSetnotifyTime::time() const {
  return time_;
}
inline void CtrlSetnotifyTime::set_time(::google::protobuf::int32 value) {
  _set_bit(0);
  time_ = value;
}
...
inline ::google::protobuf::int32 SimNotifyTime::time() const {
  return time_;
}
inline void SimNotifyTime::set_time(::google::protobuf::int32 value) {
  _set_bit(1);
  time_ = value;
}
...
// required int32 msgID = 1;
inline bool SimMsgBodyInvalidAccel::has_msgid() const {
  return _has_bit(0);
}
inline void SimMsgBodyInvalidAccel::clear_msgid() {
  msgid_ = 0;
  _clear_bit(0);
}
inline ::google::protobuf::int32 SimMsgBodyInvalidAccel::msgid() const {
  return msgid_;
}
inline void SimMsgBodyInvalidAccel::set_msgid(::google::protobuf::int32 value) {
  _set_bit(0);
  msgid_ = value;
}

// required int32 accel = 2;
inline bool SimMsgBodyInvalidAccel::has_accel() const {
  return _has_bit(1);
}
inline void SimMsgBodyInvalidAccel::clear_accel() {
  accel_ = 0;
  _clear_bit(1);
}
inline ::google::protobuf::int32 SimMsgBodyInvalidAccel::accel() const {
  return accel_;
}
inline void SimMsgBodyInvalidAccel::set_accel(::google::protobuf::int32 value) {
  _set_bit(1);
  accel_ = value;
}
...
// required int32 msgID = 1;
inline bool SimMsgBodyInvalidJerk::has_msgid() const {
  return _has_bit(0);
}
inline void SimMsgBodyInvalidJerk::clear_msgid() {
  msgid_ = 0;
  _clear_bit(0);
}
inline ::google::protobuf::int32 SimMsgBodyInvalidJerk::msgid() const {
  return msgid_;
}
inline void SimMsgBodyInvalidJerk::set_msgid(::google::protobuf::int32 value) {
  _set_bit(0);
  msgid_ = value;
}

// required int32 jerk = 2;
inline bool SimMsgBodyInvalidJerk::has_jerk() const {
  return _has_bit(1);
}
inline void SimMsgBodyInvalidJerk::clear_jerk() {
  jerk_ = 0;
  _clear_bit(1);
}
inline ::google::protobuf::int32 SimMsgBodyInvalidJerk::jerk() const {
  return jerk_;
}
inline void SimMsgBodyInvalidJerk::set_jerk(::google::protobuf::int32 value) {
  _set_bit(1);
  jerk_ = value;
}
...
inline ::google::protobuf::int32 PassengerStatus::wait_time() const {
  return wait_time_;
}
inline void PassengerStatus::set_wait_time(::google::protobuf::int32 value) {
  _set_bit(7);
  wait_time_ = value;
}
...
inline ::google::protobuf::int32 PassengerStatus::travel_time() const {
  return travel_time_;
}
inline void PassengerStatus::set_travel_time(::google::protobuf::int32 value) {
  _set_bit(8);
  travel_time_ = value;
}
