...
class BaseController(object):
    def __init__(self, log_path=None, commlog_path=None):
        ...
        self.msg_handlers = {
            ...
            api.SIM_NOTIFY_PASSENGER_LOAD_START : self.on_SIM_NOTIFY_PASSENGER_LOAD_START,
            api.SIM_NOTIFY_PASSENGER_LOAD_END : self.on_SIM_NOTIFY_PASSENGER_LOAD_END,
            api.SIM_NOTIFY_PASSENGER_UNLOAD_START : self.on_SIM_NOTIFY_PASSENGER_UNLOAD_START,
            api.SIM_NOTIFY_PASSENGER_UNLOAD_END : self.on_SIM_NOTIFY_PASSENGER_UNLOAD_END,
            api.SIM_NOTIFY_PASSENGER_DELIVERED : self.on_SIM_NOTIFY_PASSENGER_DELIVERED,
            api.SIM_NOTIFY_PASSENGER_MISDELIVERED : self.on_SIM_NOTIFY_PASSENGER_MISDELIVERED,
            api.SIM_NOTIFY_STATION_READY_LAUNCH : self.on_SIM_NOTIFY_STATION_READY_LAUNCH,
            api.SIM_NOTIFY_STATION_UNREADY_LAUNCH : self.on_SIM_NOTIFY_STATION_UNREADY_LAUNCH,
    ...
    def on_SIM_COMPLETE_VEHICLE_SPEED(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimCompleteVehicleSpeed()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_COMPLETE_STATION_LAUNCH(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimCompleteStationLaunch()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_COMPLETE_PASSENGER_LOAD_VEHICLE(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimCompletePassengerLoadVehicle()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()
    ...
    def on_SIM_NOTIFY_PASSENGER_LOAD_START(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerLoadStart()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_PASSENGER_LOAD_END(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerLoadEnd()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_PASSENGER_UNLOAD_START(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerUnloadStart()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_PASSENGER_UNLOAD_END(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerUnloadEnd()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_PASSENGER_DELIVERED(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerDelivered()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_PASSENGER_MISDELIVERED(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyPassengerMisdelivered()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_STATION_READY_LAUNCH(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyStationReadyLaunch()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()

    def on_SIM_NOTIFY_STATION_UNREADY_LAUNCH(self, msg_type, msgID, msg_time, msg_str):
        msg = api.SimNotifyStationUnreadyLaunch()
        msg.MergeFromString(msg_str)
        self.log_rcvd_msg( msg_type, msgID, msg_time, msg )
        self.send_resume()
